...
async function dataHandler(mapObjectFromFunction) {
  ...
  function findMatches(wordToMatch, zips) {
    const filtered = zips.filter((restaurant) => restaurant.zip.includes(suggestions.value) && restaurant.geocoded_column_1);
    // const regex = new RegExp(wordToMatch, 'gi');
    // return restaurant.zip.match(regex) && restaurant.geocoded_column_1.match(regex);
